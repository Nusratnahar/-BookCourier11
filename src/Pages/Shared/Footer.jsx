      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/books" className="text-secondary-foreground/70 hover:text-primary">All Books</Link></li>
              <li><Link to="/dashboard" className="text-secondary-foreground/70 hover:text-primary">Dashboard</Link></li>
            </ul>
          </div>
        ...
        <div className="mt-8 pt-8 border-t border-secondary-foreground/10 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex gap-4">
            {/* Facebook */}
            <a href="#" className="w-8 h-8 bg-secondary-foreground/10 rounded-full flex items-center justify-center hover:bg-primary">
